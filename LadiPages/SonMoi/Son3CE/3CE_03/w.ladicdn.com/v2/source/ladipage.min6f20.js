...
LadiPageScriptV2.prototype.run = function(t) {
    ...
    this.setCookie(null, "_timenow", this.runtime.timenow, 0, !0, window.location.pathname)) : this.runtime.timenow = parseFloatLadiPage(this.runtime.timenow) || 0;
    try {
    ...
    this.runtime.tmp.add_to_cart_total_discount = 0,
    ...
    Object.keys(o).forEach(function(t) {
        t != e.const.TRACKING_NAME && (e.setDataReplaceStr(t, o[t]),
        (e.isArray(r[t]) ? r[t] : [r[t]]).forEach(function(i) {
            e.isEmpty(l) ? l += "?" : l += "&",
            l += t + "=" + encodeURIComponent(i)
        }))
    });
    var s = this.runtime.isDesktop
      , c = Object.keys(this.runtime.eventData)
      , d = {};
    d[this.const.TRACKING_NAME] = e.isEmpty(o[this.const.TRACKING_NAME]) ? e.getCookie(this.const.TRACKING_NAME) : o[this.const.TRACKING_NAME],
    this.historyReplaceState(window.location.pathname + l + window.location.hash),
    ...
    var u, p = function(t, i, a, n) {
        ...
        !e.isEmpty(t))
            if (e.isEmpty(n))
                ...
                n.type == e.const.DATA_ACTION_TYPE.lightbox_video) {
                    ...
                    r && lightbox_video(n.video_url, n.video_type, r),
                    t.addEventListener("click", function(t) {
                        lightbox_video(n.video_url, n.video_type, !1),
                        e.runEventTracking(i, !1)
                    })
                }
            ...
            if (!(e.isEmpty(r) || e.runtime.tmp.gallery_playing_video && i)) {
                ...
                if (0 != o.length && 0 != o.length) {
                    ...
                    for (var p = 0; p < l.length; p++)
                        (parseFloatLadiPage(l[p].getAttribute("data-index")) || 0) == c ? l[p].classList.add("selected") : l[p].classList.remove("selected");
        ...
        l.outerHTML = '<iframe id="' + o + '" class="iframe-video-preload" data-video-type="' + n + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
        ...
        e.runEventPlayVideo(o, n, r, !1, !0, !0, a))) : e.runEventReplayVideo(o, n, !0)
    }, y = function(t, i, a) {
        t.stopPropagation();
        ...
        var s = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0
          , c = null
          , d = null;
        (parseFloatLadiPage(a.getAttribute("data-current")) || 0) > s ? (c = "prev",
        d = "right") : (c = "next",
        d = "left");
                        ...
                        if (!e.isEmpty(l)) {
                            ...
                            if (!e.isEmpty(s) && !e.isEmpty(c)) {
                                ...
                                if (!e.isEmpty(d)) {
                                    ...
                                    e.isEmpty(p) || p.parentElement.removeChild(p),
                                    e.showParentVisibility(o, function() {
                                        for (var t = o.clientHeight, i = o.querySelectorAll("select.ladi-form-control"), a = {}, n = 0; n < i.length; n++)
                                            a[i[n].getAttribute("data-store-id") + "_" + i[n].getAttribute("data-product-id") + "_" + i[n].getAttribute("data-product-variant-id")] = i[n].value;
                                        o.innerHTML = d;
                                        for (var s = o.querySelectorAll("select.ladi-form-control"), c = 0; c < s.length; c++) {
                                            s[c].removeEventListener("change", e.runtime.tmp.generateLadiSaleProduct),
                                            s[c].addEventListener("change", e.runtime.tmp.generateLadiSaleProduct);
                                        ...
                                        if (l["option.input_setting_product_variant_type"] != e.const.SETTING_PRODUCT_VARIANT_TYPE.combined) {
                                            ...
                                            t != o.clientHeight && e.updateHeightElement(r, o, 10, 10, t, o.clientHeight, u, m, !0)
                                        }
                                    })
                                }
                            }
            ...
            if (!e.isEmpty(r)) {
                ...
                if (o !== l) {
                    var s = null
                      , c = null
                      , d = null;
                    if ("headline" != a && "paragraph" != a || window.ladi(i).value(l),
                    "image" == a) {
                        if (s = document.getElementById(i),
                        e.isEmpty(s))
                            return;
                        d = e.getOptimizeImage(l, s.clientWidth, s.clientHeight, !0, !1, !1, t),
                        c = "style_add_to_cart_image_" + i;
                        var u = "";
                        u = e.isEmpty(d) ? "#" + i + "  > .ladi-image > .ladi-image-background {background-image: none;}" : "#" + i + '  > .ladi-image > .ladi-image-background {background-image: url("' + d + '");}',
                        e.createStyleElement(c, u)
                    }
                    if ("gallery" == a) {
                        if (!e.isArray(l))
                            return;
                        ...
                        for (var g = s.getElementsByClassName("ladi-gallery-control-item"), _ = function(t) {
                            ...
                            s.getElementsByClassName("ladi-gallery-control-box")[0].appendChild(f)
                        }
                        for (; g.length > l.length; )
                            g[g.length - 1].parentElement.removeChild(g[g.length - 1]);
                        c = "style_add_to_cart_gallery_" + i;
                        var v = "";
                        l.length <= 1 && (v += "#" + i + " .ladi-gallery .ladi-gallery-view .ladi-gallery-view-arrow {display: none;}",
                        ...
                        l.forEach(function(a, n) {
                            d = e.getOptimizeImage(a.src, E.clientWidth, E.clientHeight, !0, !1, !1, t),
                            v += "#" + i + ' .ladi-gallery .ladi-gallery-view-item[data-index="' + n + '"] {background-image: url("' + d + '");}',
                            d = e.getOptimizeImage(a.src, L.clientWidth, L.clientHeight, !0, !1, !1, t),
                            v += "#" + i + ' .ladi-gallery .ladi-gallery-control-item[data-index="' + n + '"] {background-image: url("' + d + '");}'
                        }),
                        s.setAttribute("data-max-item", l.length),
                        e.isEmpty(v) || e.createStyleElement(c, v)
                    }
                }
            }
        }
                                                ...
                                                if (!e.isEmpty(y)) {
                                                    ...
                                                    if (y["option.input_setting_product_variant_type"] == e.const.SETTING_PRODUCT_VARIANT_TYPE.combobox) {
                                                        if (!e.isArray(u.product.variants))
                                                            continue;
                                                        for (var f = u.product.variants[p], h = f.option_ids.split("/"), v = 0; v < h.length; v++)
                                                            _ = document.querySelector("#" + m[g].id + ' .ladi-form-item [data-product-variant-id="' + h[v] + '"]'),
                                                            e.isEmpty(_) || _.getAttribute("data-store-id") != u.store_info.id || _.getAttribute("data-product-id") != f.product_id || (_.value = f["option" + (v + 1)])
                                                    }
                                                    if (y["option.input_setting_product_variant_type"] == e.const.SETTING_PRODUCT_VARIANT_TYPE.combined) {
                                                        if (_ = m[g].querySelector("select.ladi-form-control"),
                                                        e.isEmpty(_) || _.getAttribute("data-store-id") != u.store_info.id || _.getAttribute("data-product-id") != u.product.product_id)
                                                            continue;
                                                        _.value = p + ""
                                                    }
                                                }
                ...
                if ("cart" == a) {
                    ...
                    if (!e.isEmpty(n)) {
                        ...
                        if (!e.isEmpty(r)) {
                            var o = "style_cart_" + i
                              , l = document.getElementById(o);
                            e.isEmpty(l) || l.parentElement.removeChild(l),
                            e.showParentVisibility(r, function() {
                                ...
                                var l = r.scrollHeight
                                  , s = "#" + i + " {height: " + l + "px;}";
                                if (e.createStyleElement(o, s),
                                a != l) {
                                    var c = e.findAncestor(r, "ladi-element");
                                    e.isEmpty(c) && (c = e.findAncestor(r, "ladi-section")),
                                    e.updateHeightElement(c, r, 10, 10, a, l, o, s, !1)
                                }
                            })
                        }
                    }
    ...
    this.runtime.tmp.runOptionAction = p,
    this.createCartData(),
    c.forEach(function(i) {
            ...
            if ("section" == i && !e.isEmpty(a) && !e.isEmpty(n)) {
                ...
                if (!e.isEmpty(r)) {
                    ...
                    e.isEmpty(o) || (e.runtime.list_scroll_func[t] = function() {
                        ...
                        a == e.const.VIDEO_TYPE.youtube && (i = '<iframe id="' + r + '" class="ladi-section-background-video" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>',
                        o.innerHTML += i,
                        e.runEventPlayVideo(r, a, n, !0, !0, !1)),
                        a == e.const.VIDEO_TYPE.direct && (i = '<video id="' + r + '" class="ladi-section-background-video" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;"></video>',
                        o.innerHTML += i,
                        e.runEventPlayVideo(r, a, n, !0, !0, !1))
                    }
                    )
        ...
        }(i, a.type, a["option.background_video.video_type"], a["option.background_video.video_value"]),
        p(null, i, a.type, a["option.data_action"]),
        ...
        function(t, i, a, n, r, o, l) {
            if ("countdown" == i && !e.isEmpty(a)) {
                ...
                e.isEmpty(s) || (s.setAttribute("data-type", a),
                ...
                a != e.const.COUNTDOWN_TYPE.daily || e.isEmpty(r) || e.isEmpty(o) || (s.setAttribute("data-daily-start", r),
                s.setAttribute("data-daily-end", o)))
            }
        }(i, a.type, a["option.countdown_type"], a["option.countdown_minute"], a["option.countdown_daily_start"], a["option.countdown_daily_end"], a["option.countdown_endtime"]),
        function(t, i, a) {
            if ("countdown_item" == i && !e.isEmpty(a)) {
                var n = document.getElementById(t);
                e.isEmpty(n) || n.setAttribute("data-item-type", a)
            }
        }(i, a.type, a["option.countdown_item_type"]),
        function(t, i, a, n) {
            if ("section" == i) {
                var r = document.getElementById(t);
                if (!e.isEmpty(r)) {
            ...
            if ("form_item" == i) {
                ...
                if (a == e.const.INPUT_TYPE.checkbox) {
                    ...
                    for (var l = function(t) {
                        ...
                        n[c].getElementsByTagName("span")[0].addEventListener("click", s),
                ...
                if (a == e.const.INPUT_TYPE.radio) {
                    ...
                    for (var u = function(t) {
                        ...
                        if (!e.isEmpty(a)) {
                            for (var n = a.querySelectorAll(".ladi-form-checkbox-item span"), r = 0; r < n.length; r++)
                        ...
                        n[m].getElementsByTagName("span")[0].addEventListener("click", p),
                ...
                if (!e.isEmpty(a)) {
                    ...
                    if (n > 0) {
                        for (var l = 0; l < n; l++) {
                            ...
                            e.isEmpty(s) || (o && g(t, s, o),
                            s.classList.contains("play-video") && s.addEventListener("click", r))
                        }
                        if (n <= 1)
                            for (var c = a.getElementsByClassName("ladi-gallery-view-arrow"), d = 0; d < c.length; d++)
                                ...
                                if (!e.isEmpty(i.target.value)) {
                                    ...
                                    if (!(e.isEmpty(n) || e.isEmpty(n.store_info) || e.isEmpty(n.product))) {
                                        ...
                                        if (-1 != r) {
                                            ...
                                            c <= 0 && (c = 0,
                                            (0 == n.product.variants[r].inventory_checked || s > 0) && (c = 1),
                                            i.target.value = c),
                                            1 == n.product.variants[r].inventory_checked && (c > s || 0 == s) && (i.target.value = s)
                                        }
                                    }
                                }
                            };
            ...
            if ("collection" == i) {
                ...
                if (!e.isEmpty(a)) {
                    ...
                    if (!e.isEmpty(n)) {
                        ...
                        if (r == e.const.COLLECTION_TYPE.carousel && o.classList.add("carousel"),
                        e.loadCollectionData(t, r, 1, !0, !1),
    ...
    function() {
        var i, a = document.getElementsByClassName("ladi-form"), o = null, l = null, s = null, c = null, u = null, p = null, m = null, g = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content"], y = ["name", "email", "phone", "address", "ward", "district", "state", "country"], _ = ["email", "phone"], f = e.copy(e.runtime.list_set_value_name_country).reverse(), h = function(t, i, a) {
            if (i && e.isEmpty(o[a]))
                return !1;
            var n = [];
                    ...
                    if (!e.isEmpty(c))
                        try {
                            if (!new RegExp("^" + p[l].pattern + "$",p[l].pattern_flag).test(c)) {
                                i || e.showMessage(p[l].title, null, s),
                                r = !1;
                                break
                            }
                        } catch (t) {}
            ...
            o = {};
            for (var a = t.querySelectorAll(".ladi-element .ladi-form-item-container [name]"), r = {}, c = null, d = 0; d < a.length; d++)
                c = a[d].getAttribute("name"),
                r[c] = parseInt(a[d].getAttribute("tabindex")) || 0;
            ...
            if (m.only(e.runtime.list_set_value_name_country).length == e.runtime.list_set_value_name_country.length)
                for (var g = 0; g < m.length; g++) {
                    var _ = e.runtime.list_set_value_name_country.indexOf(m[g]);
                    -1 != _ && (m[g] = f[_])
                }
            ...
            for (var v = 0; v < a.length; v++) {
                if (c = a[v].getAttribute("name"),
                a[v].required && -1 == u.indexOf(c) && u.push(c),
                "INPUT" == a[v].tagName) {
                    ...
                    "checkbox" == E) {
                        e.isArray(o[c]) || (o[c] = []),
                        a[v].checked && o[c].push(a[v].value);
                        continue
                    }
                    if ("radio" == E) {
            ...
            i || y.forEach(function(t) {
                e.isNull(o[t]) || (e.setCookie(window.location.host, "_ladipage_" + t, o[t], 365),
            ...
            if (t)
                ...
                e.isEmpty(d[e.const.TRACKING_NAME]) || (n[e.const.TRACKING_NAME] = d[e.const.TRACKING_NAME])
            }
            ...
            s.forEach(function(t) {
                ...
                i = -1 != l.indexOf(t) ? LadiFormApi[t] : i,
                n.form_data.push({
                    name: t,
                    value: i
                })
            ...
            v(t, !1),
            h(t, !1, null) && (E(!1, null, function(t) {
            ...
            m = e.getURLSearchParams(window.location.search),
            o = {},
            l = {},
            s = [],
            c = null,
            ...
            if (!e.isEmpty(y)) {
                ...
                if (!e.isEmpty(_)) {
                    if (_["option.is_add_to_cart"])
                        return;
                    c = _["option.form_config_id"]
                }
                if (a) {
                    if (e.isEmpty(e.getCookie("_capture_" + i.id)))
                        return;
                    if (v(y, a),
                    !h(y, a, r))
                        return;
                    E(a, n, function(t) {
                        ...
                        !e.isEmpty(e.runtime.tmp.capture_form_data_last[n + "_" + r]) && e.equals(e.runtime.tmp.capture_form_data_last[n + "_" + r], a) || (e.runtime.tmp.capture_form_data_last[n + "_" + r] = a,
                        e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                            "Content-Type": "application/json"
                        }))
                    })
                    ...
                    h(y, a, r)) {
                        var w = 0
                          ...
                          , O = function(t) {
                            ...
                            y.querySelector(".ladi-button > .ladi-element > .ladi-headline").innerHTML = e.runtime.tmp.form_button_headline[i.id]
                        }
                          , k = function() {
                            var a, n, r, s;
                            e.deleteCookie("_capture_" + i.id),
                            e.deleteCookie("_cart_token"),
                            e.deleteCookie("_checkout_token"),
                            e.createCartData(),
                            a = function() {
                                ...
                                A == e.const.FORM_THANKYOU_TYPE.default && (e.isEmpty(b) || e.showMessage(b, l)),
                                A == e.const.FORM_THANKYOU_TYPE.popup && (r && e.setDataReplaceElement(!1, !1, l, b),
                                window.ladi(b).show()),
                                A == e.const.FORM_THANKYOU_TYPE.url && (e.isEmpty(b) || window.ladi(b).open_url("_top", r ? o : null))
                            }
                            ,
                            n = null,
                            r = !1,
                            ...
                            ,
                            e.isEmpty(d[e.const.TRACKING_NAME]) ? s() : (n = e.runTimeout(s, 3e3),
                            e.sendRequest("POST", e.const.API_CHECKING_FORM, JSON.stringify(d), !0, {
                                "Content-Type": "application/json"
                            }, function(t, e, i) {
                          ...
                          , D = function(t, a, n, r) {
                            if (n.readyState == XMLHttpRequest.DONE) {
                                if (r == e.const.API_FORM_DATA) {
                                    ...
                                    200 == a || 201 == a ? w++ : e.getElementAHref(r).host == e.const.DOMAIN_GOOGLE_DOCS ? w++ : T++;
                                w + T == C.length && (I && !N && w >= 1 ? (N = !0,
                        ...
                        f && E(a, n, R),
                        e.isArray(S) && S.forEach(function(t) {
                            if (!e.isEmpty(t.api_url) && e.isArray(t.custom_fields)) {
                                ...
                                s == e.const.CONTENT_TYPE.form_urlencoded && (n["Content-Type"] = "application/x-www-form-urlencoded",
                                o = Object.keys(a).reduce(function(t, e) {
                                    return t.push(e + "=" + encodeURIComponent(a[e])),
                                    t
                                }, []).join("&")),
                                s == e.const.CONTENT_TYPE.json && (n["Content-Type"] = "application/json",
                                o = JSON.stringify(a)),
                                s == e.const.CONTENT_TYPE.form_data && (o = new FormData,
                ...
                if (-1 == n)
                    ...
                    if (o.length > 0) {
                        ...
                        for (var l = 0; l < o.length; l++)
                            o[l].removeEventListener("change", A),
                            o[l].addEventListener("change", A);
                        ...
                        if (!e.isEmpty(r)) {
                            var o = function() {
                                ...
                                if (e.isEmpty(t) || e.isEmpty(t.store_info) || e.isEmpty(t.product))
                                    e.isEmpty(e.runtime.tmp.timeout_product_info[r][n["option.setting_product"]]) && e.showMessage(e.const.LANG.ADD_TO_CART_NO_PRODUCT);
                                else {
                                    ...
                                    if (-1 != i) {
                                        ...
                                        e.isEmpty(m) || (m = "https://" + e.const.STATIC_W_DOMAIN + "/" + m);
                                        ...
                                        if (e.isEmpty(y) || e.isEmpty(y.value))
                                            ...
                                            if (1 == t.product.variants[i].inventory_checked && e.runtime.tmp.cart[g].quantity + _ > p && (_ = p - e.runtime.tmp.cart[g].quantity),
                                            _ > 0) {
                                                var f = function() {
                                                    e.runtime.tmp.cart[g].quantity += _,
                                                    e.addCartCookie(t.store_info.id, {
                                                        type: "LP",
                                                        product_variant_id: s,
                                                        quantity: _
                                                    }, null, function() {
            ...
            if (!e.isEmpty(i)) {
                ...
                if (!e.isEmpty(a)) {
                    ...
                    if (!e.isEmpty(n) && n["option.form_auto_capture"] && !e.isEmpty(n["option.form_config_id"])) {
                        ...
                        e.isEmpty(r) && (r = n["option.form_config_id"] + "|" + e.runtime.ladipage_id + "|" + Date.now() + "|" + e.randomId(),
                        e.setCookie(null, "_capture_" + a.id, r, 3e5 / 864e5, !1, window.location.pathname)),
                        S(a, !0, r, t.target.getAttribute("name"))
                    }
                }
            }
        }, N = {};
        y.forEach(function(t) {
            N[t] = e.getCookie("_ladipage_" + t),
            e.isEmpty(r[t]) || (N[t] = r[t])
        }),
        i = n(N);
        var x = 0
          , I = !1
          , O = function(t) {
            for (var n = a[x].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), r = 0; r < n.length; r++) {
                var o = N[t];
                if (!e.isEmpty(o))
                    if ("true" != n[r].getAttribute("data-is-select-country") && (o = i[t]),
                    "SELECT" == n[r].tagName)
                        n[r].querySelectorAll('option[value="' + o + '"]').length > 0 && (n[r].value = o,
                        I && n[r].dispatchEvent(new Event("change")));
                    else {
        ...
        for (x = 0; x < a.length; x++) {
            ...
            for (var V = a[x].querySelectorAll("[tabindex]"), F = 0, q = 0; q < V.length; q++) {
                ...
                Y > F && (F = Y),
                V[q].setAttribute("tabindex", e.runtime.tabindexForm + Y)
            }
        ...
        e.runtime.tmp.runAfterLocation.push(function() {
            ...
            for (x = 0; x < a.length; x++) {
                ...
                for (d = 0; d < c.length; d++)
                    ...
                    !e.isEmpty(u) && (i = e.runtime.eventData[u.id]["option.input_country"],
                    !e.isEmpty(i) && (t = "",
                    i = i.split(":")[0],
            ...
            if ("countdown" == e.runtime.eventData[t].type) {
                ...
                if (!e.isEmpty(i)) {
                    ...
                    if (i.hasAttribute("data-date-start") || i.hasAttribute("data-date-end"))
                        n = parseFloatLadiPage(i.getAttribute("data-date-start")) || 0,
                        r = parseFloatLadiPage(i.getAttribute("data-date-end")) || 0;
                    else {
                        ...
                        if (a == e.const.COUNTDOWN_TYPE.endtime && (r = parseInt(i.getAttribute("data-endtime")) || 0),
    ...
    e.runtime.interval_countdown = e.runInterval(u, 1e3),
    c.forEach(function(t) {
        var i = e.runtime.eventData[t];
        if ("gallery" == i.type) {
            var a = document.getElementById(t);
            if (!e.isEmpty(a)) {
                ...
                var l = function(e) {
                  ...
                  , c = function(i) {
                    i.stopPropagation(),
                    i = e.getEventCursorData(i),
                    (a.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-top") || a.getElementsByClassName("ladi-gallery")[0].classList.contains("ladi-gallery-bottom")) && (e.runtime.current_element_mouse_down_gallery_control = t,
                ...
                for (var d = a.getElementsByClassName("ladi-gallery-control-item"), u = 0; u < d.length; u++)
            ...
            if ("gallery" == i.type) {
                ...
                if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled")) {
                    var n = i[e.runtime.device + ".option.gallery_control.autoplay"]
                      , r = i[e.runtime.device + ".option.gallery_control.autoplay_time"]
                      , o = 0;
                    if (n && !e.isEmpty(r) && (o = r),
                    o > 0) {
                        var l = a.getAttribute("data-next-time")
                          , s = Date.now();
                        e.isEmpty(l) && (l = s + 1e3 * (o - 1),
                        a.setAttribute("data-next-time", l)),
                        s >= l && (m(t, !0),
                        a.setAttribute("data-next-time", s + 1e3 * o))
                    }
                }
            }
        })
    ...
    function() {
        for (var t = document.querySelectorAll(".ladi-checkout .ladi-button"), i = 0; i < t.length; i++) {
            ...
            !e.isEmpty(a) && e.isEmpty(e.findAncestor(t[i], "ladi-form")) && (a.style.setProperty("cursor", "pointer"),
            a.addEventListener("click", e.reloadPriceDiscount))
        }
        for (var n = document.querySelectorAll(".ladi-checkout .ladi-form-item input.ladi-form-control"), r = ["email", "coupon"], o = function(t) {
            ...
            -1 != r.indexOf(n[l].getAttribute("name")) && n[l].addEventListener("change", o)
    }(),
    function() {
        c.forEach(function(t) {
            var i = e.runtime.eventData[t];
            if (!e.isEmpty(i["option.data_action"])) {
                ...
                if (!e.isEmpty(a) && "true" != a.getAttribute("data-action") && i["option.data_action"].type == e.const.DATA_ACTION_TYPE.link) {
                    ...
                    a.href = e.convertDataReplaceStr(n)
                }
            }
        });
        for (var t = document.querySelectorAll(".ladi-headline a[href], .ladi-paragraph a[href], .ladi-list-paragraph a[href]"), i = 0; i < t.length; i++) {
            ...
            t[i].href = e.convertDataReplaceStr(a)
        }
    }(),
    ...
    function() {
        for (var t = 2500, i = 3800, a = 800, n = 50, r = 150, o = 500, l = 1300, s = 600, c = 1500, d = t, u = function(i, a, n, r) {
            ...
            e.isEmpty(s) ? ((l.classList.contains("rotate-2") || l.classList.contains("rotate-3") || l.classList.contains("scale")) && o.style.setProperty("width", a.clientWidth + "px"),
            ...
            if (!e.isEmpty(c)) {
                ...
                if (e.isEmpty(e.findAncestor(c, "type")))
                    if (e.isEmpty(e.findAncestor(c, "letters")))
                        ...
                        }, a)) : (e.findAncestor(c, "ladipage-animated-words-wrapper").style.setProperty("width", "2px"),
                        e.runTimeout(function() {
                            g(c, d),
                            y(d)
                        }, s));
    ...
    function() {
        if (t) {
            ...
            a)
                ...
                e.isEmpty(d[e.const.TRACKING_NAME]) || (l[e.const.TRACKING_NAME] = d[e.const.TRACKING_NAME]),
...
LadiPageScriptV2.prototype.updateHeightElement = function(t, e, i, a, n, r, o, l, s, c) {
    for (var d = [], u = e.parentElement.children, p = 0; p < u.length; p++)
        u[p].id != e.id && u[p].classList.contains("ladi-element") && d.push(u[p]);
    ...
    if (!this.isEmpty(t) && (E = parseFloatLadiPage(getComputedStyle(t).height) || 0) != y && (!c || y > E)) {
        if (t.classList.contains("ladi-section"))
            y += i;
        else {
            var L = t.getElementsByClassName("ladi-popup")[0];
            this.isEmpty(L) || (y += i,
            L.style.setProperty("height", y + "px", "important"))
        }
        l += "#" + t.id + " {height: " + y + "px;}",
        v = !0
    }
    if (this.createStyleElement(o, l),
    v) {
        var P = this.findAncestor(t, "ladi-element");
        if (this.isEmpty(P) && (P = this.findAncestor(t, "ladi-section")),
        !this.isEmpty(P)) {
            if (P.id == this.runtime.builder_section_popup_id)
                return;
...
LadiPageScriptV2.prototype.pauseAllVideo = function() {
    ...
    for (var e = document.querySelectorAll(".iframe-video-preload:not(.no-pause)"), i = 0; i < e.length; i++)
        this.runEventReplayVideo(e[i].id, e[i].getAttribute("data-video-type"), !1)
}
,
LadiPageScriptV2.prototype.runEventReplayVideo = function(t, e, i) {
    ...
    if (!this.isEmpty(a)) {
        ...
        e == this.const.VIDEO_TYPE.direct && (i ? (a.muted = !1,
        a.play()) : a.pause()),
...
LadiPageScriptV2.prototype.runEventPlayVideo = function(t, e, i, a, n, r, o, l, s) {
    ...
    if (!c.isEmpty(d)) {
        ...
        !a || r || c.isEmpty(u) || (u.classList.add("pointer-events-none"),
        d.classList.add("no-pause")),
        ...
        if (!c.isEmpty(u)) {
            ...
            if (!c.isEmpty(m)) {
                ...
                g.toLowerCase().startsWith('url("') && g.toLowerCase().endsWith('")') && (g = (g = g.substr('url("'.length)).substr(0, g.length - '")'.length),
                c.isEmpty(g) || (p = g))
            }
        }
        var y = !0;
        if (e == c.const.VIDEO_TYPE.youtube) {
            var _ = c.getVideoId(e, i)
              , f = function() {
                try {
                    if (c.runtime.isLoadYouTubeIframeAPI || (c.runtime.isLoadYouTubeIframeAPI = !0,
                    ...
                    d.outerHTML = d.outerHTML.replaceAll("<iframe", "<div").replaceAll("</iframe>", "</div>"),
                    d = document.getElementById(t),
                    ...
                    var e = function() {
                      ...
                      , u = function(e) {
                        ...
                        c.isEmpty(i) || c.isEmpty(d) ? c.runTimeout(u, 100) : (c.runResizeAll(),
                        a ? i.mute() : i.unMute(),
                        o || l || i.playVideo(),
                        c.isFunction(s) && s())
                    };
        ...
        e == c.const.VIDEO_TYPE.direct && (c.isEmpty(p) || d.setAttribute("poster", p),
        d.setAttribute("preload", "auto"),
        d.setAttribute("controlslist", "nodownload"),
        d.setAttribute("loop", ""),
        o || l || d.setAttribute("autoplay", ""),
        (n || a) && (d.setAttribute("playsinline", ""),
...
LadiPageScriptV2.prototype.playVideo = function(t, e, i, a, n, r) {
    ...
    if (!this.isEmpty(o)) {
        ...
        if (r || n || this.pauseAllVideo(),
        this.isEmpty(l)) {
            var s = o.getElementsByClassName("ladi-video")[0]
              , c = t + "_player";
            e == this.const.VIDEO_TYPE.youtube && (s.innerHTML = s.innerHTML + '<iframe id="' + c + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0;" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
            this.runEventPlayVideo(c, e, i, n, !1, a, r)),
            e == this.const.VIDEO_TYPE.direct && (s.innerHTML = s.innerHTML + '<video id="' + c + '" class="iframe-video-preload" data-video-type="' + e + '" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; object-fit: cover;"></video>',
            this.runEventPlayVideo(c, e, i, n, !1, a, r))
        } else
            this.runEventReplayVideo(l.id, e, !0)
    }
}
,
...
LadiPageScriptV2.prototype.getOptimizeImage = function(t, e, i, a, n, r, o) {
    ...
    var l = t.split("/")
      , s = l.indexOf("");
    if (-1 != s && l.length > s + 1 && (l[s + 1] = l[s + 1].toLowerCase()),
        ...
        for (var e = document.querySelectorAll(".ladi-section .ladi-section-background iframe.ladi-section-background-video"), i = 0; i < e.length; i++) {
            ...
            if (!(n <= 0 || r <= 0)) {
                var o = t.findAncestor(a, "ladi-section-background")
                  , l = o.clientWidth
                  , s = r / n * l;
                s < o.clientHeight && (l = o.clientHeight / s * l,
                s = o.clientHeight);
...
LadiPageScriptV2.prototype.runResizeAll = function() {
    ...
    try {
        ...
        t.runtime.tmp.generateAddToCart(),
        ...
        for (var e = document.querySelectorAll("#" + t.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), i = 0; i < e.length; i++)
            "block" == getComputedStyle(e[i]).display && window.ladi(e[i].id).show();
...
LadiPageScriptV2.prototype.randomId = function(t) {
    var e = Date.now()
      ...
      , a = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function(t) {
        ...
        return e > 0 ? (a = (e + a) % 16 | 0,
        e = Math.floor(e / 16)) : (a = (i + a) % 16 | 0,
        i = Math.floor(i / 16)),
        ("x" === t ? a : 3 & a | 8).toString(16)
    });
    if (t)
        for (; "-" == a[0] || a[0] == parseInt(a[0]); )
            a = a.substr(1);
    return a
}
,
    ...
    if (this.runtime.isDesktop ? i : a) {
        ...
        if (!this.isEmpty(n) && !n.classList.contains("ladi-auto-scroll")) {
            ...
            if ("section" != e) {
                ...
                r = r > 0 ? 0 : -1 * r,
                n.querySelector(".ladi-container").style.setProperty("margin-left", r + "px")
            }
...
LadiPageScriptV2.prototype.getLinkUTMRedirect = function(t, e, i) {
    ...
    if (!this.isEmpty(o)) {
        ...
        this.isEmpty(a.href) || this.isEmpty(a.host) || !this.isEmpty(this.getURLSearchParams(a.search, "utm_source")) || (a.search = a.search + (this.isEmpty(a.search) ? "?" : "&") + o)
    }
    if (i) {
...
LadiPageScriptV2.prototype.deleteCookie = function(t) {
    ...
    "/" != window.location.pathname && (document.cookie = t + "=; expires = Thu, 01 Jan 1970 00:00:00 GMT; path = " + window.location.pathname)
}
,
...
LadiPageScriptV2.prototype.getURLSearchParams = function(t, e, i) {
    ...
    !this.isEmpty(t))
        for (var n = t.substr(1).split("&"), r = 0; r < n.length; ++r) {
            var o = n[r].split("=", 2);
            this.isNull(a[o[0]]) ? 1 == o.length ? a[o[0]] = "" : a[o[0]] = decodeURIComponent(o[1].replace(/\+/g, " ")) : i && (this.isArray(a[o[0]]) || (a[o[0]] = [a[o[0]]]),
            1 == o.length ? a[o[0]].push("") : a[o[0]].push(decodeURIComponent(o[1].replace(/\+/g, " "))))
        }
    ...
    !e.isEmpty(e.runtime.eventData) && !e.runtime.tmp.is_run_show_popup) {
        ...
        if (Object.keys(e.runtime.eventData).forEach(function(t) {
            var a = e.runtime.eventData[t]
              ...
              , r = null
              , o = null;
            if (-1 != Object.keys(e.runtime.list_scroll_func).indexOf(t) && (n = document.getElementById(t),
            !e.isEmpty(n))) {
                var l = !1;
                "section" == a.type ? (r = n.offsetTop,
                (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (l = !0)) : (r = e.getElementBoundingClientRect(n).y + window.scrollY,
                (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice(!0) >= r && window.scrollY + e.getHeightDevice(!0) <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice(!0) >= r) && (l = !0)),
                l && (o = e.runtime.list_scroll_func[t],
                delete e.runtime.list_scroll_func[t],
                o())
            }
            var s = a[e.runtime.device + ".style.animation-name"];
            if (!e.isEmpty(s) && (n = document.getElementById(t),
            !e.isEmpty(n) && !n.classList.contains("ladi-animation"))) {
                ...
                e.runtime.tmp.isFirstScroll && c > 0 && !d && n.classList.add("ladi-animation-hidden"),
                d && (n.classList.add("ladi-animation"),
                e.runTimeout(function() {
            ...
            var u = null
              , p = null
              , m = null;
            if (a[e.runtime.device + ".option.sticky"] && (u = a[e.runtime.device + ".option.sticky_position"],
            p = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"]),
            m = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"])),
            !e.isEmpty(u)) {
                var g = document.getElementById(t);
                if (!e.isEmpty(g) && -1 != ["default", "top", "bottom"].indexOf(u)) {
                    var y = e.getElementBoundingClientRect(g)
                      , _ = g.getAttribute("data-top")
                      , f = g.getAttribute("data-left");
                    e.isEmpty(_) ? (g.setAttribute("data-top", y.y + window.scrollY),
                    _ = y.y) : _ = parseFloatLadiPage(_),
                    e.isEmpty(f) ? (g.setAttribute("data-left", y.x + window.scrollX),
                    f = y.x) : f = parseFloatLadiPage(f);
                    var h = null
                      , v = null;
                    if ("default" == u && (p > _ - window.scrollY ? (h = p + "px",
                    v = f + "px") : e.getHeightDevice() - m - g.clientHeight < _ - window.scrollY && (h = "calc(100% - " + (m + g.clientHeight) + "px)",
                    v = f + "px")),
                    "top" == u && (p > _ - window.scrollY || e.getHeightDevice() - 0 < _ - window.scrollY) && (h = p + "px",
                    v = f + "px"),
                    "bottom" == u && (e.getHeightDevice() - m - g.clientHeight < _ - window.scrollY || 0 > _ + g.clientHeight - window.scrollY) && (h = "calc(100% - " + (m + g.clientHeight) + "px)",
                    v = f + "px"),
                    e.isEmpty(h) || e.isEmpty(v))
                        g.style.removeProperty("top"),
                        g.style.removeProperty("left"),
                        g.style.removeProperty("width"),
                        g.style.removeProperty("position"),
                        g.style.removeProperty("z-index");
                    else if (g.style.setProperty("top", h),
                    g.style.setProperty("left", v),
                    "section" == a.type && (e.runtime.isMobileOnly ? g.style.setProperty("width", document.getElementsByClassName("ladi-wraper")[0].clientWidth + "px") : i && g.style.setProperty("width", "inherit")),
                    g.style.setProperty("position", "fixed"),
                    g.style.setProperty("z-index", "90000050"),
                    !g.hasAttribute("data-first")) {
                        g.setAttribute("data-first", !0),
                        g.classList.contains("ladi-animation-hidden") && (g.classList.remove("ladi-animation-hidden"),
                        g.classList.add("ladi-animation"));
                        for (var E = g.getElementsByClassName("ladi-animation-hidden"); E.length > 0; )
                            E[0].classList.add("ladi-animation"),
                            E[0].classList.remove("ladi-animation-hidden");
                        g.classList.remove("ladi-lazyload");
                        for (var L = g.getElementsByClassName("ladi-lazyload"); L.length > 0; )
                            L[0].classList.remove("ladi-lazyload")
                    }
                }
            }
            if ("popup" == a.type) {
                if (!e.isEmpty(e.runtime.scroll_show_popup[t]))
                    return;
                e.isEmpty(a["option.popup_welcome_page_scroll_to"]) || (n = document.getElementById(a["option.popup_welcome_page_scroll_to"]),
                e.isEmpty(n) || (r = n.offsetTop,
                (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (e.runtime.scroll_show_popup[t] = !0,
                window.ladi(t).show())))
            }
            if ("section" == a.type) {
                ...
                e.isEmpty(n) || (r = n.offsetTop,
                (window.scrollY >= r && window.scrollY <= r + n.offsetHeight || window.scrollY + e.getHeightDevice() >= r && window.scrollY + e.getHeightDevice() <= r + n.offsetHeight || r >= window.scrollY && window.scrollY + e.getHeightDevice() >= r) && (e.runtime.scroll_to_section[t] = !0,
                e.runEventTracking(t, !1)))
            }
        }),
        e.runtime.isClient)
            for (var a = Math.round((window.scrollY + e.getHeightDevice()) / document.body.clientHeight * 100), n = 1; n < e.const.PERCENT_TRACKING_SCROLL.length; n++)
                a > e.const.PERCENT_TRACKING_SCROLL[n - 1] && a <= e.const.PERCENT_TRACKING_SCROLL[n] && -1 == e.runtime.scroll_depth.indexOf(e.const.PERCENT_TRACKING_SCROLL[n]) && (e.runtime.scroll_depth.push(e.const.PERCENT_TRACKING_SCROLL[n]),
                e.isFunction(window.gtag) && window.gtag("event", "ScrollDepth_" + e.const.PERCENT_TRACKING_SCROLL[n] + "_percent", {
...
LadiPageScriptV2.prototype.runRemovePopup = function(t, e, i, a) {
    ...
    s.forEach(function(t) {
        ...
        if (!n.isEmpty(i)) {
            ...
            if (n.isEmpty(a) || a.style.removeProperty("display"),
            i.hasAttribute("data-popup-backdrop")) {
                l(),
                e && (n.isEmpty(n.runtime.tmp.bodyScrollY) || window.scrollTo(0, n.runtime.tmp.bodyScrollY)),
...
LadiPageScriptV2.prototype.runShowPopup = function(t, e, i, a, n) {
    ...
    if (!this.isEmpty(t)) {
        ...
        if (!a || !this.isEmpty(o) && !this.isEmpty(this.runtime.eventData[t])) {
            ...
            var c = 0;
            a || LadiPagePlugin.getPlugin("popup").showStyleShowPopupBuilder(t),
            a && (e = this.runtime.eventData[t][this.runtime.device + ".option.popup_position"],
            ...
            var d = function() {
                ...
                for (var n = document.querySelectorAll("#" + s.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), d = 0; d < n.length; d++)
                    n[d].id != t && n[d].style.setProperty("z-index", "1", "important");
                c = 500
            };
            ...
            d()) : a || (r += "#" + this.runtime.backdrop_popup_id + " { display: block !important;}",
            o.setAttribute("data-popup-backdrop", !0),
            d());
            var u = "block" == o.style.getPropertyValue("display");
            this.isFunction(n) && !u && (n(),
            this.isFunction(l) && l()),
            o.style.setProperty("display", "block", "important");
            var p = o.hasAttribute("data-scroll")
              , m = !1;
            if (!p && o.clientHeight > .9 * this.getHeightDevice() && (a ? (o.setAttribute("data-scroll", !0),
            o.style.setProperty("overflow-y", "auto", "important"),
            o.style.setProperty("overflow-x", "hidden", "important"),
            p = !0) : m = !0),
            p && a && (o.getElementsByClassName("ladi-popup")[0].style.removeProperty("height"),
            ...
            a || LadiPagePlugin.getPlugin("popup").styleShowPopupBuilderUpDown(t, m),
            s.isEmpty(r) || this.createStyleElement("style_popup", r),
            a && !this.isEmpty(o)) {
                var g = o.getElementsByClassName("popup-close")[0];
                this.isEmpty(g) && ((g = document.createElement("div")).className = "popup-close",
                o.appendChild(g),
                g.addEventListener("click", function(e) {
                    e.stopPropagation(),
                    s.runRemovePopup(t, a)
                })),
                ...
                var y = function() {
                    ...
                    if (!s.isEmpty(t)) {
                        var e = s.getElementBoundingClientRect(o)
                          , i = 15
                          , a = 15;
                        e.x + 30 - t.clientWidth > a && (a = e.x + 30 - t.clientWidth),
                        e.y + 30 - t.clientHeight > i && (i = e.y + 30 - t.clientHeight),
                        p && (a += s.runtime.widthScrollBar),
...
LadiPageScriptV2.prototype.runEventTracking = function(t, e) {
    if (this.runtime.isClient && !this.isEmpty(t)) {
        var i = this.runtime.eventData[t]
          ...
          , o = null
          , l = null;
        if (e && "form" == a ? (n = i["option.form_conversion_name"],
        r = i["option.form_google_ads_conversion"],
        o = i["option.form_google_ads_label"],
        l = i["option.form_event_custom_script"]) : (n = i["option.conversion_name"],
        r = i["option.google_ads_conversion"],
        o = i["option.google_ads_label"],
        l = i["option.event_custom_script"]),
        this.isFunction(window.fbq) && !this.isEmpty(n) && window.fbq("trackCustom", n),
          ...
          , d = function(t, e, i, a, n) {
            ...
            if (r.isEmpty(a) || o !== (l = r.generateProductKey(o, !0, a, i, n, !0, function(r) {
                ...
                var s = null
                  , c = e.type
                  , u = null;
                if ("headline" == c && (u = t.getElementsByClassName("ladi-headline")[0],
                r.isEmpty(u) || (u.innerHTML = l)),
                "paragraph" == c && (u = t.getElementsByClassName("ladi-paragraph")[0],
                r.isEmpty(u) || (u.innerHTML = l)),
                "image" == c) {
          ...
          , u = function(t) {
            ...
            if (!r.isEmpty(e)) {
                ...
                if (e.hasAttribute("data-max-page")) {
                    ...
                    o += "#" + t + " .ladi-collection-content .ladi-collection-page.last {",
                    o += "height: calc(" + getComputedStyle(l).height + " / " + s + " * " + u + ");",
                    o += "}",
                    r.createStyleElement(a, o)
                }
                ...
                p != m) {
                    ...
                    r.isEmpty(g) && (g = r.findAncestor(e, "ladi-section")),
                    r.updateHeightElement(g, e, 50, 10, p, m, a, o, !0)
                }
            }
        }
          , p = function(t) {
            ...
            if (!r.isEmpty(e) && e.hasAttribute("data-page")) {
                var i = "0"
                  ...
                  , s = c - l.length
                  , d = "";
                s > 0 ? (n != o.length ? n > 1 && (i = -(n - 1) + "00%") : i = "calc(-" + (n - 1) + "00% + (100% / " + c + " * " + s + "))",
                a = "calc(" + o.length + "00% - (100% / " + c + " * " + s + "))",
                d += "#" + t + " .ladi-collection-content .ladi-collection-page.last {",
                d += "width: calc(" + getComputedStyle(e).width + " / " + c + " * " + s + ");",
                d += "}") : (n > 1 && (i = -(n - 1) + "00%"),
                a = o.length + "00%");
          ...
          , m = function(t, n, o) {
            ...
            if (r.isObject(g) && r.isArray(g.products)) {
                ...
                if (!r.isEmpty(g.total_record) && i * l >= g.total_record) {
                    ...
                    y.setAttribute("data-max-page", _),
                    f = !0
                }
                if (y.setAttribute("data-page", i > _ ? _ : i),
                _ < i)
                    return;
                ...
                for (var P = E.getElementsByClassName("ladi-collection-page"); P.length < i; ) {
                    var S = document.createElement("div");
                    S.className = "ladi-collection-page",
                    E.appendChild(S)
                }
                var A = P[i - 1]
                ...
                for (var w = 0; w < g.products.length; w++)
                    if (!(b.length > w)) {
                        ...
                        for (var C = T.getElementsByClassName("ladi-element"), N = 0; N < C.length; N++) {
                            ...
                            r.isEmpty(x) || (r.isFunction(r.runtime.tmp.runOptionAction) && r.runtime.tmp.runOptionAction(C[N], C[N].id, x.type, x["option.data_action"]),
                            r.isEmpty(x["option.setting_product_key"]) || d(C[N], x, n, g.products[w].product_id, x["option.setting_product_key"]))
                        }
                    }
                f && A.classList.add("last"),
                e == r.const.COLLECTION_TYPE.carousel && p(t),
                e == r.const.COLLECTION_TYPE.readmore && u(t),
                r.runResizeAll()
            }
        };
        if (n)
            return o["option.collection_setting.type"] == r.const.COLLECTION_TYPE.readmore && u(t),
            void (o["option.collection_setting.type"] == r.const.COLLECTION_TYPE.carousel && p(t));
...
LadiPageScriptV2.prototype.reloadFeeShipping = function() {
    var t = this;
    t instanceof LadiPageScriptV2 || (t = LadiPageScript),
    t.isEmpty(t.runtime.tmp.timeout_reload_fee_shipping) || t.removeTimeout(t.runtime.tmp.timeout_reload_fee_shipping);
    var e = function(e) {
        t.runtime.tmp.add_to_cart_fee_shipping = e,
        ...
        if (t.isEmpty(i) || t.isEmpty(a))
            ...
            if (t.isEmpty(n))
                ...
                if (t.isEmpty(o) || t.isEmpty(l))
                    ...
                    var s = o.value
                      , c = l.value;
                    if (t.isEmpty(s) || t.isEmpty(c))
                        return void e(0);
                    (r = {
                        state_id: s.split(":")[0],
                        district_id: c.split(":")[0]
                    }).state_id = parseInt(r.state_id) || r.state_id,
                    r.district_id = parseInt(r.district_id) || r.district_id
                }
            }
        }
    }, 1e3)
...
LadiPageScriptV2.prototype.reloadPriceDiscount = function(t) {
    var e = this;
    if (e instanceof LadiPageScriptV2 || (e = LadiPageScript),
    !(e.runtime.tmp.is_click_check_price_discount || e.isEmpty(t) && e.isEmpty(e.runtime.tmp.current_use_coupon))) {
        e.isEmpty(e.runtime.tmp.timeout_reload_price_discount) || e.removeTimeout(e.runtime.tmp.timeout_reload_price_discount);
        var i = function(t) {
            e.runtime.tmp.add_to_cart_total_discount = t,
                            ...
                            if (r.readyState == XMLHttpRequest.DONE) {
                                if (200 == n)
                                    try {
                                        var o = JSON.parse(a);
                                        if (200 == o.code)
                                            return e.isEmpty(o.data.discount_error) ? e.runtime.tmp.current_use_coupon = u : e.isEmpty(t) || e.showMessage(o.data.discount_error),
        ...
        if (r.readyState == XMLHttpRequest.DONE) {
            if (200 == e)
                try {
                    var o = JSON.parse(t);
                    if (200 == o.code)
                        return l.setCookie(null, "_cart_token", o.data.cart_token, 30, !1, window.location.pathname),
                        l.setCookie(null, "_checkout_token", o.data.checkout_token, 30, !1, window.location.pathname),
                        l.isFunction(i) && i(),
                        l.isFunction(n) && n(),
...
LadiPageScriptV2.prototype.updateCartCookie = function(t, e, i, a) {
    ...
    this.sendRequest("POST", this.const.API_LADISALE_UPDATE, JSON.stringify(t), !0, r, function(t, n, r) {
        if (r.readyState == XMLHttpRequest.DONE) {
            if (200 == n)
                try {
                    if (200 == JSON.parse(t).code)
                        return o.isFunction(e) && e(),
                        o.isFunction(a) && a(),
                ...
                if (200 == a)
                    try {
                        ...
                        200 == r.code && r.data.items.forEach(function(e) {
                            ...
                            -1 == t.runtime.tmp.cart.findIndex(function(t) {
...
LadiPageScriptV2.prototype.changeTotalPriceCart = function() {
    ...
    if (this.runtime.tmp.cart.length > 0 && !this.isEmpty(this.runtime.tmp.cart[0].currency) && !this.isEmpty(this.runtime.tmp.cart[0].currency.symbol)) {
        ...
        r = this.formatCurrency(r, c),
        o = this.formatCurrency(o, c),
        l = this.formatCurrency(l, c),
        s = this.formatCurrency(s, c)
    }
    this.setDataReplaceStr("cart_total_price", r),
    this.setDataReplaceStr("cart_total_checkout_price", o),
    this.setDataReplaceStr("cart_fee_shipping", l),
    this.setDataReplaceStr("cart_total_discount", s),
    this.setDataReplaceStr("cart_total_quantity", e),
...
LadiPageScriptV2.prototype.removeAddToCartProduct = function(t) {
    ...
    -1 != e && this.updateCartCookie({
        ...
        0 == i.runtime.tmp.cart.length && (i.deleteCookie("_cart_token"),
        i.deleteCookie("_checkout_token")),
        i.runResizeAll()
    })
}
,
...
LadiPageScriptV2.prototype.changeAddToCartProductQuantity = function(t, e, i) {
    ...
    if (-1 != a) {
        ...
        if (this.isEmpty(t.value))
            i && (t.value = 1),
            this.runtime.tmp.cart[a].quantity = 1;
        else {
            ...
            if (1 == this.runtime.tmp.cart[a].inventory_checked) {
                ...
                o = o <= 0 ? 1 : o;
            this.runtime.tmp.cart[a].quantity = o,
            t.value = o
        }
            ...
            for (var r = document.querySelectorAll('.ladi-cart-price [data-product-variant-id="' + e + '"]'), o = 0; o < r.length; o++)
                if (r[o].getAttribute("data-store-id") == n.runtime.tmp.cart[a].store_id && r[o].getAttribute("data-product-id") == n.runtime.tmp.cart[a].product_id) {
                    ...
                    if (!n.isEmpty(l)) {
                        ...
                        if (!n.isEmpty(s) && !n.isEmpty(c) && s.id == c.id)
                            continue;
...
LadiPageScriptV2.prototype.generateCart = function(t, e, i) {
    ...
    0 == n.length)
        ...
        n.forEach(function(e) {
            ...
            a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (o = a.formatCurrency(o, e.currency.symbol)),
            r += o + "</span></td>",
            t == a.const.CART_LAYOUT.editable && (r += '<td class="ladi-cart-action"><button onclick="javascript: LadiPageScript.removeAddToCartProduct(' + e.product_variant_id + ');" type="button"><span>X</span></button></td>',
            r += "</tr>")
        })
    }
    return r += "</tbody>"
...
LadiPageScriptV2.prototype.getProductVariantIndex = function(t, e, i) {
    ...
    if (!(a.isObject(r) && a.isObject(r.store_info) && a.isObject(r.product) && a.isArray(r.product.variants)))
        return n;
                    ...
                    if (!a.isEmpty(c)) {
                        ...
                        if (!a.isEmpty(d)) {
                            ...
                            if (d["option.input_setting_product_variant_type"] == a.const.SETTING_PRODUCT_VARIANT_TYPE.combined) {
                                ...
                                if (p.getAttribute("data-store-id") != r.store_info.id || p.getAttribute("data-product-id") != r.product.product_id)
                                    return;
                                n = p.value,
                                n = a.isEmpty(n) ? -1 : parseInt(n)
                            }
                        }
                    }
                }
...
LadiPageScriptV2.prototype.generateProductKey = function(t, e, i, a, n, r, o) {
    ...
    if (l.isObject(s) && l.isObject(s.product)) {
        var c = null;
        if (-1 != ["name", "description"].indexOf(n) && (c = s.product[n],
        t = c),
        -1 != ["image"].indexOf(n) && (c = s.product[n],
        l.isObject(c) && (t = c.src,
        l.isEmpty(t) || (t = "https://" + l.const.STATIC_W_DOMAIN + "/" + t))),
        -1 != ["images"].indexOf(n) && (c = s.product[n],
        l.isArray(c) && (t = [],
        ...
        l.isArray(s.product.variants) && s.product.variants.length > 0) {
            ...
            if (-1 != d) {
                ...
                if (-1 != ["title", "sku"].indexOf(n) && (c = u[n],
                t = c),
                -1 != ["text_quantity"].indexOf(n) && (c = 1 == u.inventory_checked ? u[n] : "",
                t = c),
                -1 != ["weight"].indexOf(n) && (c = u[n],
                l.isEmpty(u.weight_unit) || (c += u.weight_unit),
                t = c),
                -1 != ["price"].indexOf(n) && (c = l.formatNumber(u[n], 3),
                l.isObject(s.store_info) && l.isObject(s.store_info.currency) && !l.isEmpty(s.store_info.currency.symbol) && (c = l.formatCurrency(c, s.store_info.currency.symbol)),
                t = c),
                -1 != ["src"].indexOf(n)) {
                    if (c = u[n],
                    l.isEmpty(c)) {
                        if ("src" == n)
                            return l.generateProductKey(t, e, i, a, "image", !1, o)
                    } else
                        c = "https://" + l.const.STATIC_W_DOMAIN + "/" + c;
                    t = c
                }
            }
        }
...
LadiPageScriptV2.prototype.generateVariantProduct = function(t, e, i, a, n, r, o, l, s, c) {
    ...
    if (!u.isEmpty(t) && !u.isEmpty(i)) {
        u.isEmpty(u.runtime.tmp.product_info[i]) && (u.runtime.tmp.product_info[i] = {}),
        u.isEmpty(u.runtime.tmp.timeout_product_info[i]) && (u.runtime.tmp.timeout_product_info[i] = {}),
        t = parseInt(t) || t;
        var p = u.runtime.tmp.product_info[i][t]
          , m = function() {
            if (!e)
                return u.isObject(p) ? p : null;
            var t = "";
            if (u.isObject(p)) {
                if (!u.isObject(p.product))
                    return t;
                a == u.const.SETTING_PRODUCT_VARIANT_TYPE.combined && (t += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select data-store-id="' + p.store_info.id + '" data-product-id="' + p.product.product_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (l ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">",
                u.isArray(p.product.variants) && p.product.variants.forEach(function(e, i) {
                    var a = e.title;
                    if (r) {
                        var n = u.formatNumber(e.price, 3);
                        u.isObject(p.store_info) && u.isObject(p.store_info.currency) && !u.isEmpty(p.store_info.currency.symbol) && (n = u.formatCurrency(n, p.store_info.currency.symbol)),
                        a += " - " + n
                    }
                    t += '<option value="' + i + '">' + a + "</option>"
                }),
                t += "</select></div></div>"),
                a == u.const.SETTING_PRODUCT_VARIANT_TYPE.combobox && u.isArray(p.product.options) && p.product.options.forEach(function(e) {
                    0 != e.values.length && (t += '<div class="ladi-form-item-box">',
                    u.isEmpty(n) || (t += '<div class="ladi-form-item-title"><span>' + e.name + "</span></div>"),
                    t += '<div class="ladi-form-item-container"><div class="ladi-form-item-background"></div><div class="ladi-form-item"><select data-store-id="' + p.store_info.id + '" data-product-id="' + e.product_id + '" data-product-variant-id="' + e.product_option_id + '" required tabindex="' + o + '" class="ladi-form-control ladi-form-control-select" data-selected=""' + (l ? "" : ' onmousedown="javascript: event.preventDefault();"') + ">",
        ...
        if (u.isNull(p)) {
            ...
            return u.sendRequest("POST", u.const.API_SHOW_PRODUCT, JSON.stringify(g), !0, {
                ...
                if (n.readyState == XMLHttpRequest.DONE)
                    try {
                        if (u.isObject(u.runtime.tmp.product_info[i][t]))
                            p = u.runtime.tmp.product_info[i][t];
                        else {
                            var r = JSON.parse(e);
                            p = r.data
                        }
                        u.isObject(p) ? (u.runtime.tmp.product_info[i][t] = p,
                        d = m(),
                        u.isFunction(c) && c(d)) : (u.runtime.tmp.product_info[i][t] = !1,
                        u.isEmpty(u.runtime.tmp.timeout_product_info[i][t]) || (u.removeTimeout(u.runtime.tmp.timeout_product_info[i][t]),
                        delete u.runtime.tmp.timeout_product_info[i][t]))
                    } catch (e) {
                        u.runtime.tmp.product_info[i][t] = !1,
                        u.isEmpty(u.runtime.tmp.timeout_product_info[i][t]) || (u.removeTimeout(u.runtime.tmp.timeout_product_info[i][t]),
                        delete u.runtime.tmp.timeout_product_info[i][t])
                    }
            }),
...
LadiPageScriptV2.prototype.getListProductByTagId = function(t, e, i, a, n, r, o) {
    ...
    if (l.isArray(i) && i.length > 0 && !l.isEmpty(t)) {
        l.isEmpty(l.runtime.tmp.product_tag_info[t]) && (l.runtime.tmp.product_tag_info[t] = {}),
        l.isEmpty(l.runtime.tmp.timeout_product_tag_info[t]) && (l.runtime.tmp.timeout_product_tag_info[t] = {}),
        i.sort();
        var c = JSON.stringify(i) + "_page_" + n + "_limit_" + a
          ...
          , u = function() {
            ...
            l.isEmpty(l.runtime.tmp.product_info[t]) && (l.runtime.tmp.product_info[t] = {}),
        ...
        if (l.isNull(d)) {
            ...
            return l.isEmpty(e) ? p.type = "group" : p.paged = n,
            l.sendRequest("POST", l.const.API_COLLECTION_PRODUCT, JSON.stringify(p), !0, {
                "Content-Type": "application/json",
                "Store-Id": t
            }, function(e, i, a) {
                if (a.readyState == XMLHttpRequest.DONE)
                    try {
                        var n = JSON.parse(e);
                        d = n.data,
                        l.isObject(d) ? (l.runtime.tmp.product_tag_info[t][c] = d,
                        s = u(),
                        l.isFunction(o) && o(s)) : (l.runtime.tmp.product_tag_info[t][c] = !1,
                        l.isEmpty(l.runtime.tmp.timeout_product_tag_info[t][c]) || (l.removeTimeout(l.runtime.tmp.timeout_product_tag_info[t][c]),
                        delete l.runtime.tmp.timeout_product_tag_info[t][c]))
                    } catch (e) {
                        l.runtime.tmp.product_tag_info[t][c] = !1,
                        l.isEmpty(l.runtime.tmp.timeout_product_tag_info[t][c]) || (l.removeTimeout(l.runtime.tmp.timeout_product_tag_info[t][c]),
                        delete l.runtime.tmp.timeout_product_tag_info[t][c])
                    }
            }),
            ...
            if (3 !== t.nodeType)
                ...
                t.textContent.replace(l, function(e, i) {
                    var n = document.createTextNode(t.textContent.slice(c, i))
                      , r = null;
                    o.isFunction(a) ? r = a(e) : (r = document.createElement("span")).textContent = e,
                    s.appendChild(n),
                    s.appendChild(r),
                    c = i + e.length
                });
...
LadiPageScriptV2.prototype.convertDataReplaceStr = function(t, e, i, a) {
    for (var n = this, r = t, o = new RegExp(n.runtime.replacePrefixStart + "[^" + n.runtime.replacePrefixStart + "$" + n.runtime.replacePrefixEnd + "]*" + n.runtime.replacePrefixEnd,"gi"), l = null, s = [], c = function(t) {
        if (i)
            ...
            var e = t
              , o = e.split("|");
            e = o[0].substr(n.runtime.replacePrefixStart.length),
            1 == o.length && (e = e.substr(0, e.length - n.runtime.replacePrefixEnd.length));
            var l = n.getDataReplaceStr(e, a);
            if (n.isEmpty(l))
                if (o.length > 1) {
                    var c = n.randomInt(1, o.length - 1);
                    l = o[c],
                    c == o.length - 1 && (l = l.substr(0, l.length - n.runtime.replacePrefixEnd.length))
                } else
                    l = "";
            r = r.replaceAll(t, l)
        }
        ...
        l.forEach(c);
    return s = s.unique(),
    n.highlightText(e, s, !0, function(t) {
            ...
            if (-1 != n.indexOf(g)) {
                ...
                if (!this.isNull(y) && ("country" != g || "true" != p[m].getAttribute("data-is-select-country"))) {
                    ...
                    if ("INPUT" == p[m].tagName) {
                        ...
                        if ("checkbox" == f || "radio" == f) {
                            ...
                            if ("checkbox" == f) {
                                var v = y;
                                this.isArray(v) || (v = [v]),
                                h = -1 != v.indexOf(p[m].getAttribute("value"))
                            }
                            "radio" == f && (h = p[m].getAttribute("value") == _.trim()),
                            h ? (p[m].checked = !0,
                    ...
                    "SELECT" == p[m].tagName) {
                        ...
                        if (!this.isEmpty(P) && (p[m].value = P.getAttribute("value"),
                        e && !P.hasAttribute("selected"))) {
                            for (var S = p[m].querySelectorAll("option"), A = 0; A < S.length; A++)
                                S[A].removeAttribute("selected");
...
LadiPageScriptV2.prototype.showMessage = function(t, e, i) {
    if (this.isEmpty(t))
        ...
        if (this.isEmpty(a)) {
            var n = this;
            t = n.convertDataReplaceStr(t, null, !1, e),
...
var Base64 = {
    ...
    _utf8_decode: function(t) {
        for (var e = "", i = 0, a = 0, n = 0, r = 0; i < t.length; )
            ...
            i++) : a > 191 && a < 224 ? (r = t.charCodeAt(i + 1),
            e += String.fromCharCode((31 & a) << 6 | 63 & r),
            i += 2) : (r = t.charCodeAt(i + 1),
            n = t.charCodeAt(i + 2),
            e += String.fromCharCode((15 & a) << 12 | (63 & r) << 6 | 63 & n),
            i += 3);
        return e
    }
}
...
var LadiFormApi = LadiFormApi || {}
  ...
  , lightbox_run = function(t, e, i, a, n, r, o, l) {
    ...
    if (!LadiPageScript.isEmpty(s)) {
        ...
        var p = document.getElementById(n)
          , m = !1;
        LadiPageScript.isEmpty(p) ? (p = document.createElement("div"),
        s.appendChild(p),
        p.outerHTML = t,
        p = s.lastChild,
        m = !0) : i && LadiPageScript.runEventReplayVideo(n, r, !0);
        ...
        var y = function() {
            if (p = p = document.getElementById(n),
                ...
                if ("IFRAME" == p.tagName) {
                    ...
                    if (t > 0 || e > 0) {
                        var i = .9 * document.body.clientWidth
                          ...
                          , o = e / t * r;
                        o > a && (r = (o = a) * (t / e)),
                        p.style.setProperty("width", (parseFloatLadiPage(r) || 0) + "px"),
                        p.style.setProperty("height", (parseFloatLadiPage(o) || 0) + "px")
                    }
                }
                if (g = s.getElementsByClassName("lightbox-close")[0],
          ...
          , _ = function() {
            LadiPageScript.runTimeout(function() {
                ...
                LadiPageScript.isEmpty(p) || (p.setAttribute("data-opacity", 0),
                p.removeAttribute("data-hidden")),
                g = s.getElementsByClassName("lightbox-close")[0],
                LadiPageScript.isEmpty(g) || (g.setAttribute("data-opacity", 0),
        ...
        var f = "load";
        if (i && r == LadiPageScript.const.VIDEO_TYPE.direct && (f = "loadedmetadata"),
        m && (p.addEventListener(f, _),
        p.addEventListener("error", _)),
        i) {
            var h = e;
            r == LadiPageScript.const.VIDEO_TYPE.youtube && (e = null,
            h = o),
            m ? LadiPageScript.runEventPlayVideo(n, r, h, !1, !1, !0, !1, l, function(t) {
                LadiPageScript.isEmpty(t) ? _() : (t.addEventListener(f, _),
        ...
        var L = function() {
            ...
            p = p = document.getElementById(n),
            LadiPageScript.isEmpty(p) || (a && !i ? p.parentElement.removeChild(p) : (p.classList.add("lightbox-hidden"),
        ...
        LadiPageScript.isEmpty(s.getAttribute("data-load-event")) && (s.setAttribute("data-load-event", !0),
        s.addEventListener("click", function(t) {
            t.stopPropagation(),
            t.target.id == s.id && (g = s.getElementsByClassName("lightbox-close")[0],
  ...
  , lightbox_iframe = function(t, e, i, a, n, r) {
    if (!LadiPageScript.isEmpty(t)) {
        ...
        LadiPageScript.isEmpty(c) || "IFRAME" != c.tagName || (s = c.src,
        i = c.id || i,
...
LadiPageLibraryV2.prototype.open_url = function(t, e) {
    if (!LadiPageScript.isEmpty(this.id)) {
        ...
        if (!LadiPageScript.isEmpty(a)) {
            ...
            n.search = n.search + (LadiPageScript.isEmpty(n.search) ? "?" : "&") + a,
            i = n.href
        }
...
LadiPageLibraryV2.prototype.value = function(t) {
    if (!LadiPageScript.isEmpty(this.id)) {
        ...
        for (n = 0; n < a.length; n++) {
            var o = !1;
            "checkbox" == a[n].getAttribute("type").toLowerCase() && -1 != r.indexOf(a[n].value) && (o = !0),
            "radio" == a[n].getAttribute("type").toLowerCase() && r.length > 0 && r[0] == a[n].value && (o = !0),
            o ? a[n].checked || a[n].click() : a[n].checked && a[n].click()
        }
    }
}
,
...
LadiPageLibraryV2.prototype.show = function() {
    ...
    if (!LadiPageScript.isEmpty(t)) {
        ...
        0 == t.getElementsByClassName("ladi-popup").length ? (t.style.setProperty("display", "block", "important"),
        i(),
        LadiPageScript.runResizeSectionBackground(),
        LadiPageScript.reloadLazyload()) : (LadiPageScript.runShowPopup(this.id, null, null, !0, function() {
            for (var t = document.querySelectorAll("#" + LadiPageScript.runtime.builder_section_popup_id + " .ladi-container > .ladi-element"), e = 0; e < t.length; e++)
                t[e].id != this.id && t[e].hasAttribute("data-popup-backdrop") && "block" == t[e].style.getPropertyValue("display") && LadiPageScript.runRemovePopup(t[e].id, !0)
        }),
...
(LadiPageAppV2 = LadiPageAppV2 || function() {}
        ...
        if (!LadiPageScript.isEmpty(d)) {
            var u = document.getElementById(e)
              ...
              , h = function() {
                ...
                m != n && m != r && m != o || u.style.setProperty("top", -u.clientHeight - 100 + "px"),
                ...
                var e = -1
                  , i = function() {
                    if (e + 1 < t.length) {
                        ...
                        m != n && m != r && m != o || u.style.removeProperty("top"),
    ...
    i.prototype.stop = function(t, e) {
        LadiPageScript.removeTimeout(a),
        a = null
    }
    ,
    new i
...
(LadiPageAppV2 = LadiPageAppV2 || function() {}
    ...
    i.prototype.add_turn = function(e) {
        var i = t["option.spinlucky_setting.max_turn"]
          , n = a(e);
        n > 0 && n--,
        LadiPageScript.setCookie(null, "_total_turn_" + e, n, 1, !1, window.location.pathname),
