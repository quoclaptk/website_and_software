            ...
            var _ = c.getVideoId(e, i),
                f = function ()
                {
                    try
                    {
                        ...
                        console.log(111), new window.YT.Player(t,
                        {
                            videoId: _,
                            playerVars:
                            {
        ...
        if (Object.keys(e.runtime.eventData).forEach(function (t)
            {
                ...
                if (a[e.runtime.device + ".option.sticky"] && (u = a[e.runtime.device + ".option.sticky_position"], p = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_top"]), m = parseFloatLadiPage(a[e.runtime.device + ".option.sticky_position_bottom"])), !e.isEmpty(u))
                {
                    ...
                    if (!e.isEmpty(g) && -1 != ["default", "top", "bottom"].indexOf(u))
                    {
                        ...
                        else if(g.style.setProperty("top",h),g.style.setProperty("left",v),"section"==a.type&&(e.runtime.isMobileOnly?g.style.setProperty("width",document.getElementsByClassName("ladi-wraper")[0].clientWidth+"px"):i&&g.style.setProperty("width", "inherit")),g.style.setProperty("position","fixed"),g.style.setProperty("z-index","90000050"),!g.hasAttribute("data-first"))
                        {
