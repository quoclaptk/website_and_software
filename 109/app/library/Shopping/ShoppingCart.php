...
class ShoppingCart extends Component
{
    ...
    */
    public function add($product = array(), $isUpdate = false)
    {
        ...
        if (!isset($product["id"]) || !isset($product["qty"]) || !isset($product["price"])) {
            $this->_instanceLog();
            $this->_logger->error(
    ...
    */
    ...
    {
        return $this->_cart['cart_total'] ? $this->_cart['cart_total'] : 0;
    }
    ...
    */
    ...
    {
        return (isset($this->_cart['total_items'])) ? $this->_cart['total_items'] : 0;
    }
