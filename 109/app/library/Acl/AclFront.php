...
use Modules\Frontend\Models\Profiles;
...
class AclFront extends Component
{
    ...
    private $_privateResources = array(
        'users' => array('index', 'search', 'edit', 'create', 'delete', 'changePassword','deletemulty','transfer'),
        'profiles' => array('index', 'search', 'edit', 'create', 'delete'),
        'permissions' => array('index'),
        'category'=> array('index','edit','create','delete','show','update','import')
    );
