                            ...
                            {% for item in page.items %}
                                {% if loop.first %}
                                    ...
                                    <tr>
                                        ...
                                        <th>Ví trí</th>
                                        <th width="10%" class="text-center">Main menu</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {% if item.main == 'Y' %}
                                            {{ link_to(ACP_NAME ~ '/' ~ controller_name ~ '/hidemain/' ~ item.id ~ '/' ~ page_current, '<i class="fa fa-check-square-o fa-lg"></i>' ) }}
                                        {% else %}
                                            {{ link_to(ACP_NAME ~ '/' ~ controller_name ~ '/showmain/' ~ item.id ~ '/' ~ page_current, '<i class="fa fa-square-o fa-lg"></i>' ) }}
                                        {% endif %}
                                    </td>
                                    <td class="text-center">
                                        {% if item.active == 'Y' %}
