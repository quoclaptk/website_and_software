                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    {#<div class="form-group row">
                                        <div class="col-md-2"><label for="banner">Hiện Popup đăng ký</label></div>
                                        <div class="col-md-8">
                                            <label>
                                                <input type="checkbox" name="popup" value="Y" {% if item is not defined %}checked{% elseif item.popup == 'Y' %}checked{% endif %}>
                                            </label>
                                        </div>
                                    </div>#}
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-md-6"><label for="banner">Hiện bảng đăng ký</label></div>
                                                <div class="col-md-6">
                                                    <label>
                                                        {{ form.render("reg_form",{'class':'form-control'}) }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="row">
                                                <div class="col-md-6"><label for="banner">Hiện bảng tin nhắn</label></div>
                                                <div class="col-md-6">
                                                    <label>
                                                        {{ form.render("messenger_form",{'class':'form-control'}) }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group editor-form">
                                        ...
                                        <p></p>
                                        {{ partial('partials/ajaxupload', ['id': row_id, 'type':'news_menu', 'img_upload_paths':img_upload_paths]) }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group editor-form">
                                            <label for="description">Nội dung</label>
                                            <p></p>
                                            {{ partial('partials/ajaxupload', ['id': row_id_lang[langCode], 'type':'news_menu', 'img_upload_paths':img_upload_lang_paths[langCode]]) }}
