                            ...
                            {% for item in page.items %}
                                {% if loop.first %}
                                    ...
                                    <tr>
                                        ...
                                        <th>Tên</th>
                                        <th class="text-center">Danh sách danh mục</th>
                                ...
                                <tr>
                                    ...
                                    {% if item.static != 'Y' %}
                                    <td class="text-center">{{ link_to(ACP_NAME ~ '/news_category/index/' ~ item.id, 'class':'btn btn-link', '<i class="fa fa-eye"></i> Quản trị</a>' ) }}</td>
                                    <td class="text-center">{{ link_to(ACP_NAME ~ '/news/index/' ~ item.id, 'class':'btn btn-link', '<i class="fa fa-eye"></i> Quản trị</a>' ) }}</td>
                                    {% else %}
                                    ...
                                    <td class="text-center">
                                        {#{% if item.id not in arr_list_j_category and item.id not in arr_list_j_news %}#}
