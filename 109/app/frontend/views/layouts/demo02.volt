            ...
            <div id="box_content_inner">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="{% if layout_config.hide_left == 'Y' and layout_config.hide_right == 'Y' %}col-md-12 {% elseif (layout_config.hide_left == 'Y' and layout_config.hide_right == 'N') or (layout_config.hide_left == 'N' and layout_config.hide_right == 'Y') %}col-md-9 {% else %}col-md-6 {% endif %}col-sm-12 clearfix col-center">
                    ...
                    {% else %}
                        {% if setting.layout_id == 2  %}
                            {% if layout_config.show_left_inner == 'Y' and layout_config.show_right_inner == 'Y' %}
                                <div class="row">
                                    {{ partial('partials/left', ["layout": 2]) }}
                                    <div class="col-md-6 col-sm-12 clearfix col-center">{{ content() }}</div>
                                    {{ partial("partials/right", ["layout": 2]) }}
                                </div>
                        ...
                        {% else %}
                            <div class="row">
                                {{ partial('partials/left', ["layout": 2]) }}
                                <div class="col-md-9 col-sm-12 clearfix col-center">{{ content() }}</div>
                                {{ partial("partials/right", ["layout": 2]) }}
                            </div>
                        {% endif %}
                    {% endif %}
...
{{ partial('partials/outsite', ['layout':2]) }}