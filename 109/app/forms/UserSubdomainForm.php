...
class UserSubdomainForm extends Form
{
    public function initialize($entity = null, $options = null)
    {
        ...
        $subdomain_name = new Text('subdomain_name', array(
            'placeholder' => 'Tên domain(Viết liền không dấu)'
        ));

        $subdomain_name->addValidators(array(
