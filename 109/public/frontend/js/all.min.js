...
$(".list_product_care").owlCarousel({loop:false,margin:30,nav:true,dots:true,autoplay:false,autoplayTimeout:4E3,autoplayHoverPause:true,responsive:{0:{items:1,nav:false,loop:false,dots:false},420:{items:2,nav:false},480:{items:2,nav:false},768:{items:3,nav:false},992:{items:3},1200:{items:4}}});$(function(){$(".lazy").lazy({placeholder:"data:image/gif;base64,R0lGODlhEALAPQAPzl5uLr9Nrl8e7..."})});
