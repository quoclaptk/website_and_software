 ...
 */
    ...
    jQuery(document).ready(function(){
        ...
        var src_img_width = 430;
        var src_img_height = 480;
        var ratio_width = 430;
        var ratio_height = 480;
        
        src_img_width = 430 * ratio_width / ratio_height;
...
(function(jQuery){
    ...
    jQuery.fn.moreview = function(options){
        ...
        var o = jQuery.extend({
            ...
            smallthumb_inactive_opacity: 1,    // Opacity of the inactive small thumbnails (number between or equal to 0-1)
