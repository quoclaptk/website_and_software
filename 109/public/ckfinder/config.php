...
function CheckAuthentication()
{
    ...
    return $_SESSION['auth-identity']['isLoggedIn'];
}
...
*/
//$baseUrl = '/bongdaviet/home/files/';
$identity = $_SESSION['subdomain-child'];
$baseUrl =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ?  "https" : "http");
$baseUrl .=  "://".$_SERVER['HTTP_HOST'];
$baseUrl .=  str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
$baseUrl = str_replace("/ckfinder/core/connector/php/", "/", $baseUrl);
$baseUrl = '/public/files/' . $identity['folder'] . '/';

// $baseUrl = 'http://'.$_SERVER["SERVER_NAME"] . '/public/files/' . $identity['folder'] . '/';
...
ATTENTION: The trailing slash is required.LicenseName
*/
$baseDir = resolveUrl($baseUrl);
// $baseDir = __DIR__.'/../files/' . $identity['folder'] . '/';
